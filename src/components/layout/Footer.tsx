...
export function Footer() {
  ...
  return (
    <footer className="px-8 md:px-16 pt-16 pb-10 border-t border-white/[0.08]">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-6">
        ...
        <div className="flex flex-col gap-3">
          ...
          <a href="mailto:hello@parkerandlenox.com"
             className="font-mono text-[0.65rem] tracking-[0.15em] text-white/60 hover:text-cream transition-colors hoverable break-all">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center gap-5">
            ...
            <a href="https://facebook.com/parkerandlenox" target="_blank" rel="noopener noreferrer" aria-label="Facebook"
               className="opacity-60 hover:opacity-100 transition-opacity hoverable" style={{ color: 'rgba(237,232,220,0.8)' }}>
              <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href="https://tiktok.com/@parkerandlenox_" target="_blank" rel="noopener noreferrer" aria-label="TikTok"
               className="opacity-60 hover:opacity-100 transition-opacity hoverable" style={{ color: 'rgba(237,232,220,0.8)' }}>
      ...
      <div className="max-w-6xl mx-auto mt-14 pt-6 border-t border-white/[0.05] flex flex-col md:flex-row items-start md:items-center justify-between gap-2">
