  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div
          className="absolute top-[38%] md:top-[39%] -translate-y-1/2 z-10 flex items-center justify-center rounded-full transition-transform duration-300 w-12 h-12 md:w-24 md:h-24"
          style={{
            background: 'var(--color-black)',
        ...
        <p
          className="absolute font-mono text-[0.55rem] md:text-[0.825rem] tracking-[0.3em] uppercase whitespace-nowrap opacity-40 top-[calc(38%+40px)] md:top-[calc(39%+70px)]"
